            ...
            try:
                ...
                try:
                    ...
                    if ans != LastDataSent:
                        ...
                        #sys.stdout.flush()
                        file = open("salida_reg.txt", "a")
                        file.write(ans)
                        file.flush()
                        file.close()
                        #print "[DEBUG ALEX]: Este texto sustituye la salida del command utilzado"
                    else:
...
if __name__ == '__main__':
    ...
    print type(command)
    print command
    print type(options.path)
    print options.path
    print type(options.file)
    print options.file
    print type(options.c)
    print options.c
    print type(options.port)
    print options.port
    print type(username)
    print username
    print type(password)
    ...
    print type(domain)
    print domain
    print type(options.hashes)
    print options.hashes
    print type(options.aesKey)
    print options.aesKey
    print type(options.k)
    print options.k
    print type(options.dc_ip)
    print options.dc_ip
    print "=========RUN========"
    print type(remoteName)
    print remoteName
    print type(options.target_ip)
